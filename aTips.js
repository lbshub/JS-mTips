		...
		_create: function() {
			if (!this.BG) {
				var body = document.getElementsByTagName('body')[0],
					html = '<table><tr><td><div id="aTips_box"><div id="aTips_content"></div><div id="aTips_foot"><a href="javascript:;" id="aTips_cancel">取消</a><a href="javascript:;" id="aTips_define">确定</a></div></div></td></tr></table>';
